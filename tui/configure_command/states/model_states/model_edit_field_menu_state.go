...
func (s *ModelEditFieldMenuState) Init(m *model.Model) tea.Cmd {
	items := []list.Item{
...
func (s *ModelEditFieldMenuState) Update(msg tea.Msg, m *model.Model) tea.Cmd {
	var cmd tea.Cmd
...
func (s *ModelEditFieldMenuState) View(m *model.Model) string {
	return m.List.View()
}
