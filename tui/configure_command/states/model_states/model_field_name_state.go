...
func (s *ModelFieldNameState) Init(m *model.Model) tea.Cmd {
...
func (s *ModelFieldNameState) Update(msg tea.Msg, m *model.Model) tea.Cmd {
	var cmd tea.Cmd
...
func (s *ModelFieldNameState) View(m *model.Model) string {
